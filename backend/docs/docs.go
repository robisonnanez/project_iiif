...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/documents/{id}/ocr/pages/{page}/words": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Palabra a localizar",
                        "name": "q",
                        "in": "query",
                        "required": true
                    },
                    {
                        "type": "integer",
                        "default": 100,
                        "description": "Máximo de apariciones (máximo 1000)",
                        "name": "limit",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/services.OCRWordSearchResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "services.OCRWordSearchResponse": {
            "type": "object",
            "properties": {
                "document_id": {
                    "type": "string"
